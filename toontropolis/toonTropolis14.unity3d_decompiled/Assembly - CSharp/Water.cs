...
public class Water : MonoBehaviour
{
	...
	public void OnWillRenderObject()
	{
		...
		if (waterMode >= Water.WaterMode.Reflective)
		{
			...
			Transform arg_1C4_0 = camera.get_transform();
			Vector3 eulerAngles2 = new Vector3(0f, eulerAngles.y, eulerAngles.z);
			arg_1C4_0.set_eulerAngles(eulerAngles2);
			camera.Render();
	...
	private void OnDisable()
	{
		...
		{
			Object.DestroyImmediate(((Camera)dictionaryEntry.Value).get_gameObject());
		}
		this.m_ReflectionCameras.Clear();
		foreach (DictionaryEntry dictionaryEntry2 in this.m_RefractionCameras)
		{
			Object.DestroyImmediate(((Camera)dictionaryEntry2.Value).get_gameObject());
		}
	...
	{
		Matrix4x4 arg_31_0 = projection.get_inverse();
		...
		projection.set_Item(2, vector3.x - projection.get_Item(3));
		projection.set_Item(6, vector3.y - projection.get_Item(7));
		projection.set_Item(10, vector3.z - projection.get_Item(11));
		projection.set_Item(14, vector3.w - projection.get_Item(15));
	}
