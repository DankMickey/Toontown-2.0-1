	...
	public override void Explode()
	{
		...
		if (this._explodeDelay <= 0f)
		{
			...
			for (int i = 0; i < num; i++)
			{
				...
				Transform arg_137_0 = gameObject.get_transform();
				float arg_132_0 = Random.get_value();
				Vector3 vector3 = new Vector3(this._tmpScale, this._tmpScale, this._tmpScale);
				arg_137_0.set_localScale(arg_132_0 * vector3);
