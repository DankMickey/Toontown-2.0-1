...
public class Detonator : MonoBehaviour
{
	...
	private static Color _baseColor = Detonator._baseColor;
	...
	public static Material DefaultFireballAMaterial()
	{
		...
		Material arg_7F_0 = Detonator.defaultFireballAMaterial;
		Vector2 mainTextureScale = new Vector2(0.5f, 1f);
		arg_7F_0.set_mainTextureScale(mainTextureScale);
		return Detonator.defaultFireballAMaterial;
	}
	...
	public static Material DefaultFireballBMaterial()
	{
		...
		Material arg_7F_0 = Detonator.defaultFireballBMaterial;
		Vector2 mainTextureScale = new Vector2(0.5f, 1f);
		arg_7F_0.set_mainTextureScale(mainTextureScale);
		Material arg_9B_0 = Detonator.defaultFireballBMaterial;
		Vector2 mainTextureOffset = new Vector2(0.5f, 0f);
		arg_9B_0.set_mainTextureOffset(mainTextureOffset);
		return Detonator.defaultFireballBMaterial;
	}
	...
	public static Material DefaultSmokeAMaterial()
	{
		...
		Material arg_7F_0 = Detonator.defaultSmokeAMaterial;
		Vector2 mainTextureScale = new Vector2(0.5f, 1f);
		arg_7F_0.set_mainTextureScale(mainTextureScale);
		return Detonator.defaultSmokeAMaterial;
	}
	...
	public static Material DefaultSmokeBMaterial()
	{
		...
		Material arg_7F_0 = Detonator.defaultSmokeBMaterial;
		Vector2 mainTextureScale = new Vector2(0.5f, 1f);
		arg_7F_0.set_mainTextureScale(mainTextureScale);
		Material arg_9B_0 = Detonator.defaultSmokeBMaterial;
		Vector2 mainTextureOffset = new Vector2(0.5f, 0f);
		arg_9B_0.set_mainTextureOffset(mainTextureOffset);
		return Detonator.defaultSmokeBMaterial;
	}
