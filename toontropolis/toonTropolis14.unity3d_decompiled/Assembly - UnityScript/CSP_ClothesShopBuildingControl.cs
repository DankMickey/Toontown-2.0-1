...
[Serializable]
public class CSP_ClothesShopBuildingControl : MonoBehaviour
{
	[CompilerGenerated]
	[Serializable]
	internal sealed class ToggleSleepWake$39 : GenericGenerator<WaitForSeconds>
	{
		internal CSP_ClothesShopBuildingControl $self_164;

		public ToggleSleepWake$39(CSP_ClothesShopBuildingControl self_)
		{
			this.$self_164 = self_;
		}
		...
		{
			return new CSP_ClothesShopBuildingControl.ToggleSleepWake$39.$(this.$self_164);
		}
	}
	...
	public CSP_ClothesShopBuildingControl()
	{
	...
	{
		return new CSP_ClothesShopBuildingControl.ToggleSleepWake$39(this).GetEnumerator();
	}
