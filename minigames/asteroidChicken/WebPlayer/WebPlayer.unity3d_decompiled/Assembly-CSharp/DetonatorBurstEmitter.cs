	...
	public override void Explode()
	{
		if (this.on)
		{
			...
			if (this._explodeDelay <= 0f)
			{
				...
				{
					this._tmpPos = Vector3.Scale(Random.get_insideUnitSphere(), new Vector3(this._scaledStartRadius, this._scaledStartRadius, this._scaledStartRadius));
					this._tmpPos = this._thisPos + this._tmpPos;
					this._tmpDir = Vector3.Scale(Random.get_insideUnitSphere(), new Vector3(this.velocity.x, this.velocity.y, this.velocity.z));
