...
public class DetonatorSmoke : DetonatorComponent
{
	...
	{
		this._smokeA.get_transform().set_localPosition(Vector3.Scale(this.localPosition, new Vector3(this.size, this.size, this.size)));
	...
	{
		this._smokeB.get_transform().set_localPosition(Vector3.Scale(this.localPosition, new Vector3(this.size, this.size, this.size)));
