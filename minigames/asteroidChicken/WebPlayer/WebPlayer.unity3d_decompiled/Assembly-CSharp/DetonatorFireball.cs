...
public class DetonatorFireball : DetonatorComponent
{
	...
	{
		this._fireballA.get_transform().set_localPosition(Vector3.Scale(this.localPosition, new Vector3(this.size, this.size, this.size)));
	...
	{
		this._fireballB.get_transform().set_localPosition(Vector3.Scale(this.localPosition, new Vector3(this.size, this.size, this.size)));
	...
	{
		this._fireShadow.get_transform().set_localPosition(Vector3.Scale(this.localPosition, new Vector3(this.size, this.size, this.size)));
