...
public class DragRigidbody : MonoBehaviour
{
	[CompilerGenerated]
	[Serializable]
	internal sealed class $DragObject$3 : GenericGenerator<object>
	{
		internal float $distance$10;

		internal DragRigidbody $self_$11;

		public $DragObject$3(float distance, DragRigidbody self_)
		{
			this.$distance$10 = distance;
			this.$self_$11 = self_;
		}

		public override IEnumerator<object> GetEnumerator()
		{
			return new DragRigidbody.$DragObject$3.$(this.$distance$10, this.$self_$11);
		}
	}
	...
	{
		return new DragRigidbody.$DragObject$3(distance, this).GetEnumerator();
	}
